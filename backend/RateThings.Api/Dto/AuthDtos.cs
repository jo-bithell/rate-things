...
public record UserDto(string Id, string Email, string DisplayName, string? ImageUrl, string Role);
...
public record PendingUserDto(string Id, string Email, string DisplayName, DateTimeOffset CreatedAt);

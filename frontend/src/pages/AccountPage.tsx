...
export default function AccountPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6 pb-20 sm:pb-6 space-y-6">
      ...
      <div className="card">
        <h2 className="font-display font-bold mb-3">Change password</h2>
      ...
      <div className="rounded-2xl border-2 border-rose-300 bg-rose-50 p-4">
        <h2 className="font-display font-bold mb-1 text-rose-700">Danger zone</h2>
